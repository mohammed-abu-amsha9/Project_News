    ...
    <style>
        * {
        ...
        .image-side {
            flex: 1;
            min-width: 300px;
            background: url('{{ asset('implication/img/pngtree-revolutionizing-the-world-of-business-and-technology-a-breaking-news-template-image_3705379.jpg') }}') center/cover no-repeat;
            min-height: 200px;
        }
    ...
    <div class="container">
        <div class="form-side">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <a href="{{ route('forgot-password') }}">هل نسيت كلمة السر؟</a>
                <hr />
                <a href="{{ route('register') }}">ليس لديك حساب؟ <b>سجل</b></a>
            </form>
        </div>
