...
@section('content')
    <div class="container my-5" style="max-width: 600px;">
        <h2 class="mb-4 text-center">إنشاء دور جديد</h2>
        ...
        <form action="{{ route('roles.store') }}" method="POST" class="p-4"
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control" placeholder="أدخل اسم الدور"
                    value="{{ old('name') }}" required autofocus>
            </div>

            <button type="submit" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"
                class="btn text-white btn-block mt-4">حفظ التصنيف</button>
        </form>
    </div>
@endsection
@section('scripts')
